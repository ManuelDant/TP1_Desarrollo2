...
//blic class ScriptRifle : MonoBehaviour
//
...
//      {
//          return;
//          //pistol.OnDropWeapon(); // Llamar el m�todo OnPickUpWeapon() en el script de la otra arma
//      }
//
//      float radius = 2f;
...
//              {
//                  EnemyMovementStrategyManager enemy = hit.collider.gameObject.GetComponent<EnemyMovementStrategyManager>();
//                  if (enemy != null)
//                  {
//                      enemy.TakeDamage(10);
